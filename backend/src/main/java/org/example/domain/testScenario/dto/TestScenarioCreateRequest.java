...
public record TestScenarioCreateRequest(
        ...
        @Schema(example = "기능", description = "기능 | 성능 | 보안 | 회귀 | 기타") String type,
        @Schema(example = "높음", description = "높음 | 보통 | 낮음") String priority,
        @Schema(example = "작성중", description = "작성중 | 검토중 | 승인됨 | 실행중 | 통과 | 실패 | 보류") String status,

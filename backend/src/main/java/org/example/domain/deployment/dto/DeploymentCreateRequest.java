...
public record DeploymentCreateRequest(
        @Schema(example = "로그인 기능 v1.0 운영 배포") String title,
        ...
        @Schema(example = "정기배포", allowableValues = {"정기배포", "긴급패치", "핫픽스", "롤백", "기타"}) String type,
        @Schema(example = "운영", allowableValues = {"개발", "스테이징", "운영"}) String environment,
        @Schema(example = "대기", allowableValues = {"대기", "진행중", "완료", "실패", "롤백"}) String status,

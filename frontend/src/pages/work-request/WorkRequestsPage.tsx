  ...
  return (
    <div className="p-4 sm:p-6 space-y-4">
      <PageHeader
        title="업무요청"
        count={data?.total ?? 0}
        action={{ label: '업무요청 등록', onClick: () => navigate('/work-requests/new'), icon: <PlusIcon /> }}
      />
      ...
      <div className="bg-white rounded-xl border border-blue-50 shadow-[0_2px_8px_rgba(30,58,138,0.05)] px-3 sm:px-4 py-3 flex items-center gap-3 flex-wrap">
        ...
        <FilterSelect value={filterType} onChange={(v) => { setFilterType(v as RequestType | '전체'); setPage(1) }} options={['전체', '기능개선', '신규개발', '버그수정', '인프라', '기타']} placeholder="유형" className="w-[120px]" />
